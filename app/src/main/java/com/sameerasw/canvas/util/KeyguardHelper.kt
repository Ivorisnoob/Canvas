 ...
 * Handles checking lock status and requesting unlock with authentication.
 */
object KeyguardHelper {
     ...
     *
     * Note: This can only be called once the device is unlocked and the user has
     * consented to unlocking behavior. On Android 14+, this is more restrictive.
     */
